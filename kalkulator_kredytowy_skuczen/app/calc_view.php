...
<body>
	...
	<form action="<?php print(_APP_URL);?>/app/calc.php" method="post">
		...
		<input id="id_x" type="number" name="x" value="<?php out($x); ?>" /><br />
		<label for="id_o">Oprocentowanie: </label>
		<input id="id_o" type="text" name="o" value="<?php out($o); ?>" />%<br />
		
		<label for="id_y">Na ile miesięcy: </label>
		<input id="id_y" type="number" name="y" value="<?php out($y); ?>" /><br />
