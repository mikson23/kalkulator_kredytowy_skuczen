...
<main class="form-signin w-22 m-auto">
  <form action="<?php print(_APP_ROOT);?>/app/security/login.php" method="post">
    <img class="mb-4" src="<?php print(_APP_ROOT);?>/css/logo.png" alt="" width="72" height="72">
    <h1 class="h3 mb-3 fw-normal">Logowanie</h1>
    <br>
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="login" value="<?php out($form['login']); ?>">
	...
	<!--
		Przycisk zapamiętywania użytkownika
    ...
    <p class="mt-5 mb-3 text-body-secondary">Strona wykonana przez Mikołaja Skuczeń</p>
	<?php
