...
<header class="p-2 mb-3 border-bottom">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="<?php print(_APP_URL); ?>" class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
          <img src="<?php print(_APP_ROOT);?>/css/logo.png" alt="home" height="50px">
        </a>

        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="#" class="nav-link px-2 link-body-emphasis">Kalkulator</a></li>
          <li><a href="#" class="nav-link px-2 link-secondary">2...</a></li>
          <li><a href="#" class="nav-link px-2 link-secondary">3...</a></li>
          <li><a href="#" class="nav-link px-2 link-secondary">4...</a></li>
        </ul>
        ...
        <div class="dropdown text-end">
          ...
          <ul class="dropdown-menu text-small">
            ...
            <li><a class="dropdown-item" href="<?php print(_APP_ROOT); ?>/app/security/logout.php">Sign out</a></li>
          </ul>
        </div>
      </div>
    </div>
