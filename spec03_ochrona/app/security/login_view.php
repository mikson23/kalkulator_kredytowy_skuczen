...
<body>
	...
	<form action="<?php print(_APP_ROOT);?>/app/security/login.php" method="post">
		<div class="form-floating mb-3">
			<input type="text" class="form-control" id="id_login" name="login" placeholder="1" value="<?php out($form['login']); ?>">
			<label for="id_login">Login:</label>
		</div>
		<div class="form-floating mb-3">
			<input type="password" class="form-control" id="id_pass" name="pass" placeholder="1" 
			>
		...
		<input type="submit" class="btn btn-outline-success" value="Zaloguj" />
	</form>	
